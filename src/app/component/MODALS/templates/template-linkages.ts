...
export const TEMPLATE_LINKAGES: Record<TemplateID, string> = {
  ...
  Cylinder_Boom:
    '2P.Fe,1E8.K,0.1011.KO,O,0,0,0.GC,C,0,_W,0.KG,G,ku,0,0.GN,N,Ju,Z-,0.OP,P,R0,QX,0.pS,S,R0,QX,0,GN,G,N..YROC,OC,Fe,Fe,0,VG,c5cae9,O,C,,.YRGN,GN,Fe,Fe,XO,I0,303e9f,G,N,,.YRPC,PC,Fe,Fe,DW,iW,0d125a,P,C,,.YPPS,PS,Fe,0,0,0,,P,S,,...N_f',
  Pivoting_Gripper:
